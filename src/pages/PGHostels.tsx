...
const PGHostels = () => {
  ...
  const setupRealtimeListener = () => {
    try {
      setLoading(true);
      console.log('Setting up real-time listener for PG/Hostels properties...');
      
      const propertiesCollection = collection(db, 'properties');
      
      // Enhanced real-time listener with metadata changes
      const unsubscribe = onSnapshot(
        ...
        (querySnapshot) => {
          console.log('Real-time PG properties update received');
          ...
          const propertiesData = querySnapshot.docs.map(doc => {
            ...
            return {
              ...
              images: Array.isArray(data.images) ? data.images.filter(img => 
            ...
            // Enhanced filter logic for PG/Hostels with subcategories
          ...
          console.log('Filtered PG properties:', propertiesData);
  ...
  const filterProperties = () => {
    ...
    // Apply subcategory filter for PG/Hostels
    if (selectedType !== 'all') {
      filtered = filtered.filter(property => {
    ...
    console.log('Filtered properties:', filtered, 'Selected type:', selectedType);
  ...
  // Updated property types to match the new subcategory system
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white mb-12">
            ...
            <p className="text-xl text-gray-200 max-w-3xl mx-auto">
              Find comfortable and affordable accommodation options for students and working professionals
            </p>
          </div>
          ...
          {loading ? (
                  ...
                  <div className="relative">
                    <div className="flex justify-between items-center mb-4">
                      <h3 className="text-lg font-semibold text-gray-900">
                        {filteredProperties.length} PG/Hostel Properties
                      </h3>
                      <button
                        ...
                        >
                          <div className="bg-white rounded-lg overflow-hidden shadow-sm border border-gray-100 transition-all duration-300 hover:shadow-md">
                            <div className="relative h-32 overflow-hidden">
                              <img 
                                src={property.images[0] || 'https://images.unsplash.com/photo-1555854877-bab0e460b1e5?q=80&w=500'}
                                alt={property.title}
                                className="w-full h-full object-cover"
                                onError={(e) => {
                                  e.currentTarget.src = 'https://images.unsplash.com/photo-1555854877-bab0e460b1e5?q=80&w=500';
                                }}
                              />
                              {property.featured && (
              ...
              <div className="hidden md:block">
                <div className="flex justify-between items-center mb-8">
                  <h2 className="text-3xl font-bold text-gray-900">
                    {filteredProperties.length} PG/Hostel Properties Found
                    {selectedType !== 'all' && (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-gray-600 mb-6">
                {selectedType !== 'all' 
                  ? `No properties found for "${selectedType}". Try selecting a different type or clearing filters.`
