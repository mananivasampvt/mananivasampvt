...
Message: ${formData.message}`;
    ...
    const whatsappUrl = `https://wa.me/919121055512?text=${encodedMessage}`;
            ...
            <div className="space-y-8">
              ...
              <Card className="hover-lift bg-green-50 border-green-200">
                <CardContent className="p-6 text-center">
                  ...
                  <Button
                    onClick={() => window.open('https://wa.me/919121055512?text=Hi%20I%20would%20like%20to%20inquire%20about%20a%20property%20on%20your%20website.', '_blank')}
