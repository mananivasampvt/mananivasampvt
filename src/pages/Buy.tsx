...
const Buy = () => {
  ...
  const fetchProperties = async () => {
    try {
      // Query for properties with "For Sale" in category or containing "Sale"
      const q = query(
  ...
  const propertyTypes = ['all', 'Flat for Sale', 'House for Sale', 'Villa', 'Apartment', 'Land'];
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white mb-12">
            ...
            <p className="text-xl text-gray-200 max-w-3xl mx-auto">
              Discover your dream property from our exclusive collection of flats and houses for sale
            </p>
          </div>
              ...
              <div className="md:hidden">
                {!showAllOnMobile ? (
                  <div className="relative">
                    ...
                    {/* Horizontal Scrollable Mini Cards - More Compact */}
                    <div className="flex overflow-x-auto scrollbar-hide gap-3 pb-4 px-1">
                      {filteredProperties.slice(0, 10).map((property, index) => (
                        <div
                          key={property.id}
                          className="flex-none w-44 opacity-0 animate-[fade-in-up_0.6s_ease-out_forwards] cursor-pointer"
                          style={{animationDelay: `${index * 0.1}s`}}
                          onClick={() => navigate(`/property/${property.id}`)}
                        >
                          {/* Compact Mini Property Card */}
                          <div className="bg-white rounded-lg overflow-hidden shadow-sm border border-gray-100 transition-all duration-300 hover:shadow-md">
                            ...
                            <div className="relative h-28 overflow-hidden">
                              ...
                              />
                              {property.featured && (
                                <div className="absolute top-1.5 left-1.5 bg-red-600 text-white px-2 py-0.5 rounded text-xs font-medium">
                                  Featured
                                </div>
                              )}
                  ...
                  /* Mobile Expanded List View - More Compact */
                    ...
                    <div className="space-y-2">
                      {filteredProperties.map((property, index) => (
                        ...
                        >
                          ...
                          {/* Main Card Content - Horizontal Layout, More Compact */}
                          <div className="flex">
                            ...
                            <div className="flex-1 px-2.5 py-1 flex flex-col pr-10">
                              ...
                              {/* Title */}
                              <div className="mb-1">
                                <h3 className="text-xs font-medium text-gray-800 leading-tight line-clamp-1">
                                  {property.title}
                                </h3>
                              </div>
                          ...
                          {/* Dedicated Bottom Row for Action Buttons - Reduced padding */}
                          <div className="border-t border-gray-100 px-2.5 py-1.5">
                            <div className="flex gap-2">
                              <Button 
                                ...
                                variant="outline"
                                className="flex-1 h-7 text-xs border-red-200 text-red-600 hover:bg-red-50 hover:border-red-600 rounded-2xl font-medium transition-all duration-200 shadow-sm hover:shadow-md"
                              >
                                View Details
                              </Button>
                              <Button 
