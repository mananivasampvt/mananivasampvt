...
import { Search, Filter, MapPin, Building, ChevronRight, Square, Heart, Send } from 'lucide-react';
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white mb-12">
            ...
            <p className="text-xl text-gray-200 max-w-3xl mx-auto">
              Discover prime commercial spaces for your business growth and investment opportunities
            </p>
          </div>
              ...
              <div className="md:hidden">
                {!showAllOnMobile ? (
                  <div className="relative">
                    ...
                    {/* Compact Horizontal Scrollable Mini Cards */}
                          ...
                          <div className="bg-white rounded-lg overflow-hidden shadow-sm border border-gray-100 transition-all duration-300 hover:shadow-md">
                            <div className="relative h-28 overflow-hidden">
                              <img 
                                ...
                                onError={(e) => {
                                  e.currentTarget.src = 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=500';
                                }}
                              />
                              {property.featured && (
