        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white mb-12">
            ...
            <p className="text-xl text-gray-200 max-w-3xl mx-auto">
              Find your perfect rental property from our curated collection of homes and apartments
            </p>
          </div>
                  ...
                  <div className="relative">
                    <div className="flex justify-between items-center mb-4">
                      <h3 className="text-lg font-semibold text-gray-900">
                        {filteredProperties.length} Properties for Rent
                      </h3>
                      <button
                          ...
                          <div className="bg-white rounded-lg overflow-hidden shadow-sm border border-gray-100 transition-all duration-300 hover:shadow-md">
                            <div className="relative h-28 overflow-hidden">
                              <img 
                                ...
                                onError={(e) => {
                                  e.currentTarget.src = 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?q=80&w=500';
                                }}
                              />
                              {property.featured && (
